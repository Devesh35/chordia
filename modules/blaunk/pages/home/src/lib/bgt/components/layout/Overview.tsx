...
const initialExportDetails: TableRow[] = [
  ...
  { id: 4, column1: 'Terms', column2: 'Hardcoded Value ' },
  ...
  { id: 9, column1: 'Export License	', column2: 'Hardcoded Value ' },
  { id: 10, column1: 'Origin', column2: 'Hardcoded Value ' },
  { id: 11, column1: 'On Delivery Date Payment', column2: 'Hardcoded Value ' },
  { id: 12, column1: 'Swift Bank Charge', column2: 'Hardcoded Value ' },
  { id: 13, column1: 'Currency Acceptance', column2: 'Hardcoded Value ' },
  { id: 14, column1: 'Shipping Container Capacity', column2: 'Hardcoded Value ' },
  { id: 15, column1: 'Export Market', column2: 'Hardcoded Value ' },
];
...
const initialProductSpecifications: TableRow[] = [
  ...
  { id: 13, column1: 'Weight', column2: 'Spec 1' },
  { id: 14, column1: 'Shipping weight', column2: 'Spec 1' },
  { id: 15, column1: 'Dimension LxBxH (cms)', column2: 'Spec 1' },
  { id: 16, column1: 'Dimension LxBxH (inch)', column2: 'Spec 1' },
  { id: 17, column1: 'Return Days', column2: 'Spec 1' },
  { id: 18, column1: 'Date of Posting', column2: 'Spec 1' },
  { id: 19, column1: 'Colour/Shades', column2: 'Spec 1' },
  { id: 20, column1: 'Product Condition', column2: 'Spec 1' },
  { id: 21, column1: 'Product Listing', column2: 'Spec 1' },
];
