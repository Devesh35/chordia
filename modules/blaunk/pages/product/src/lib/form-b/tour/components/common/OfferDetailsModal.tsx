...
function OfferDetailsModal({ show, handleClose, handleSave }: OfferDetailsModalProps) {
  ...
  const handleSaveChanges = () => {
    if (value.maxValue && value.flatDiscount) {
      handleSave(value);
      handleClose();
    } else {
      ...
      <Modal.Body>
        <Form>
          <Form.Group className="mb-3">
            ...
            <Form.Select value={value.offerCode} onChange={(e) => handleChange('offerCode', e)} autoFocus>
          ...
          <Row>
            <Col lg={6} xs={6}>
              <Form.Group className="mb-3">
                ...
                <Form.Control value={value.maxValue} onChange={(e) => handleChange('maxValue', e)} />
              </Form.Group>
            </Col>
            <Col lg={6} xs={6}>
              <Form.Group className="mb-3">
                <Form.Label>Flat Discount</Form.Label>
                <Form.Control value={value.flatDiscount} onChange={(e) => handleChange('flatDiscount', e)} />
              </Form.Group>
            </Col>
          </Row>
        </Form>
