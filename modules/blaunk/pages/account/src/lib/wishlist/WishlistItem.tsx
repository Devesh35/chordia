...
export const dummyItems = getRandomImagesArray(10)(300, 300, 'clothes').map(
  (s, i) => ({
    image: s,
    name: `Shirt ${i + 1}`,
    mrp: 500,
...
const WishlistItem: React.FC<WishlistItemProps> = ({
  ...
  return (
    <div className={styles['wishlist-item']}>
      <img src={image} alt={name} className={styles['wishlist-item__image']} />
      <div className={styles['wishlist-item__details']}>
        ...
        <p
          className={clsx(
            styles['wishlist-item__base'],
            styles['wishlist-item__discount'],
          )}
        >
        ...
        <Link
          href={link}
          className={styles['wishlist-item__link']}
          target="_blank"
