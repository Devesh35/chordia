        ...
        <Accordion defaultActiveKey="0" flush>
              ...
              <Container>
                <Row>
                  ...
                  <Form.Group as={Col} lg={3} md={4} sm={6} xs={12}>
                    ...
                    />
                    {errors.vehicleModel && (
                      <Form.Text className="text-danger">{errors.vehicleModel.message}</Form.Text>
                    )}
                  </Form.Group>
                  <Form.Group as={Col} lg={3} md={4} sm={6} xs={12}>
                  ...
                  <Form.Group as={Col} lg={3} md={4} sm={6} xs={12}>
                    ...
                    />
                    {errors.criminalCase && (
                      <Form.Text className="text-danger">{errors.criminalCase.message}</Form.Text>
                    )}
                  </Form.Group>
                  <Form.Group as={Col} lg={3} md={4} sm={6} xs={12}>
            ...
            <Accordion.Body>
              <Container>
                ...
                <Row className=" mt-5">
                  ...
                  हैं। <br />
                  பதிவேற்றிய அனைத்து ஆவணங்களும் உங்கள் அறிவுக்கு ஏற்றது & நோட்டரி சரிபார்க்கப்பட்டது &
                  உறுதியளிக்கப்பட்டது
                  {/* cspell:enable */}
                </Row>
              </Container>
          ...
          <Accordion.Item eventKey="3">
            ...
            <Accordion.Body>
              ...
              <div className="text-center ">
                Listing fees is Non-Refundable and Inclusive of all Govt Levied & Taxes.
              </div>
              <div className="text-center">
                If Service provider fails to provide required services, penalty of penalty of Rs. 100 will be levied.
              </div>
              <div className="text-center">
                Any complain on Service provider's misbehaviour will lead to immediate action or profile will get
                blocked without any prior intimation.
              </div>
              <div className="text-center">
            ...
            <Accordion.Header>
              ...
              <Row className="w-100 align-items-center">
                <Col md={4} className="d-flex">
                  <Image src="https://i.ibb.co/L88jqR1/lead-logo.png" width={32} height={35} alt="lead" />
                </Col>
