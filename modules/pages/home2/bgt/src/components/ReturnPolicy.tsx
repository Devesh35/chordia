  ...
  return (
    <div className={styles['policy-wrapper']}>
      ...
      <div className={styles['return-desc']}>
        If Customer found to misuse excessively Returning / Cancelling order or not accepting the order placed,Blaunk
        reserve the rights to Warn / Suspend / Block / Terminate such customer account as necessary with penalty of Rs
        500 ($6 ) towards processing charge. "To proceed Cancellation contact Blaunk Customer Care Email id:
        cuscare@blaunk.com Subject to Vendor approval and Vendor Policy "{' '}
      </div>
      <div>
        ...
        <DetailsTable
          ...
          data={[
            ...
            ['Delay In supply', 'Penalty for every 2 days delay (0.05% add on)'],
